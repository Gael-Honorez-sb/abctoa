...
//Name: shader_assignation.ma
//Last modified: Thu, Feb 05, 2015 06:46:56 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -n "RenderCam";
	setAttr ".t" -type "double3" -0.04452072046928842 1.8874172589327141 8.9832727199154423 ;
...
createNode camera -n "RenderCamShape" -p "RenderCam";
	...
	setAttr ".fl" 50;
	setAttr ".fcp" 1000000;
	setAttr ".coi" 14.200149892801893;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
...
createNode alembicHolder -n "Robot_Subdivided_And_ShadedShape" -p "Robot_Subdivided_And_Shaded";
	...
	setAttr -s 4 ".shds";
	setAttr ".sa" -type "string" "{\"EyeBallSG\": [\"/Robot/eyeball\"], \"aiStandard45SG\": [\"/Robot/pupil2\"], \"aiStandard43SG\": [\"/Robot/Robot\"], \"blue_irisSG\": [\"/Robot/iris\"]}";
	setAttr ".attr" -type "string" "{\"/Robot\": {\"subdiv_type\": 1}}";
createNode transform -n "Robot_Body_Matte";
	setAttr ".t" -type "double3" -0.64186630449347826 0 -1.4390695746066979 ;
createNode alembicHolder -n "Robot_Body_MatteShape" -p "Robot_Body_Matte";
	addAttr -ci true -sn "skipJson" -ln "skipJson" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "skipOverrides" -ln "skipOverrides" -min 0 -max 1 -at "bool";
	setAttr -k off ".v";
	setAttr ".ovlod" 1;
	...
	setAttr ".csp" -type "string" "";
	setAttr ".sa" -type "string" "{\"EyeBallSG\": [\"/Robot/eyeball\"], \"aiStandard45SG\": [\"/Robot/pupil2\"], \"aiStandard43SG\": [\"/Robot/Robot\"], \"blue_irisSG\": [\"/Robot/iris\"]}";
	setAttr ".attr" -type "string" "{\"/Robot\": {\"subdiv_type\": 1}, \"/Robot/Robot\": {\"matte\": true}}";
createNode transform -n "Robot_Invisible_In_Reflection";
	setAttr ".t" -type "double3" 1.7930695507874741 0 -1.4390695746066979 ;
createNode alembicHolder -n "Robot_Invisible_In_ReflectionShape" -p "Robot_Invisible_In_Reflection";
	addAttr -ci true -sn "skipJson" -ln "skipJson" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "skipOverrides" -ln "skipOverrides" -min 0 -max 1 -at "bool";
	setAttr -k off ".v";
	setAttr ".ovlod" 1;
	...
	setAttr ".csp" -type "string" "";
	setAttr ".sa" -type "string" "{\"EyeBallSG\": [\"/Robot/eyeball\"], \"aiStandard45SG\": [\"/Robot/pupil2\"], \"aiStandard43SG\": [\"/Robot/Robot\"], \"blue_irisSG\": [\"/Robot/iris\"]}";
	setAttr ".attr" -type "string" "{\"/Robot\": {\"subdiv_type\": 1, \"visibility\": 187}}";
createNode transform -n "Robot_Overrided";
	setAttr ".t" -type "double3" 4.1090513398931368 0 -1.4390695746066979 ;
createNode alembicHolder -n "Robot_OverridedShape" -p "Robot_Overrided";
	addAttr -ci true -sn "skipJson" -ln "skipJson" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "skipOverrides" -ln "skipOverrides" -min 0 -max 1 -at "bool";
	setAttr -k off ".v";
	setAttr ".ovlod" 1;
...
connectAttr "Robot_OverridedShape.iog" "aiStandard49SG.dsm" -na;
